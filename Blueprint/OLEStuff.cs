...
namespace Blueprint
{
    //This is a bunch of code straight out of the SDK
    //SE is made for COM environment. We're writing for .NET environment.
    //I believe this thing makes the gears mesh - Do not touch
